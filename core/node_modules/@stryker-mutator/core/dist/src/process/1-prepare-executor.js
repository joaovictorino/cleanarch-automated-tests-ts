...
export class PrepareExecutor {
    ...
    async execute(cliOptions) {
        ...
        const validator = optionsValidatorInjector.injectClass(OptionsValidator);
...
PrepareExecutor.inject = tokens(commonTokens.injector);
