    ...
    async importJSConfig(configFile) {
        ...
        if (this.hasDefaultExport(importedModule)) {
            ...
            function describeNamedExports() {
                const namedExports = (typeof importedModule === 'object' && Object.keys(importedModule !== null && importedModule !== void 0 ? importedModule : {})) || [];
...
ConfigReader.inject = tokens(commonTokens.logger, coreTokens.optionsValidator);
