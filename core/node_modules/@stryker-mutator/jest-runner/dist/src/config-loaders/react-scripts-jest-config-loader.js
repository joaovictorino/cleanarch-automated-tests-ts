...
export class ReactScriptsJestConfigLoader {
    ...
    async loadConfig() {
        ...
        try {
            ...
            config.watchPlugins = (_a = config.watchPlugins) === null || _a === void 0 ? void 0 : _a.filter(isString).map((watchPlugin) => this.resolve(watchPlugin, { paths: [reactScriptsLocation] }));
            this.setEnv();
            return config;
        }
        catch (e) {
...
ReactScriptsJestConfigLoader.inject = tokens(commonTokens.logger, pluginTokens.resolve, pluginTokens.processEnv, pluginTokens.requireFromCwd);
