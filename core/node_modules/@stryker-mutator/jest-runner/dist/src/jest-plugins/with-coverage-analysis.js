...
function setupFramework(jestConfig, overrides, jestWrapper) {
    var _a, _b;
    const testRunner = (_a = jestConfig.testRunner) !== null && _a !== void 0 ? _a : getJestDefaults(jestWrapper).testRunner;
    if (testRunner === 'jest-jasmine2') {
        overrides.setupFilesAfterEnv = [
            ...
            ...((_b = jestConfig.setupFilesAfterEnv) !== null && _b !== void 0 ? _b : []),
        ];
    }
...
function overrideEnvironment(jestConfig, overrides, jestWrapper) {
    var _a;
    const originalJestEnvironment = (_a = jestConfig.testEnvironment) !== null && _a !== void 0 ? _a : getJestDefaults(jestWrapper).testEnvironment;
