 ...
 */
export declare function transform(ast: Ast, mutantCollector: I<MutantCollector>, transformerContext: Pick<TransformerContext, 'logger' | 'mutateDescription' | 'options'>): void;
