...
export function throwPlacementError(error, nodePath, placer, mutants, fileName) {
    var _a, _b;
    const location = `${path.relative(process.cwd(), fileName)}:${(_a = nodePath.node.loc) === null || _a === void 0 ? void 0 : _a.start.line}:${(_b = nodePath.node.loc) === null || _b === void 0 ? void 0 : _b.start.column}`;
